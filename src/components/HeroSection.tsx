      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate mb-6 sm:mb-8 leading-tight fade-in-up stagger-3">
            ...
            <br className="hidden sm:block" />
            <span className="block">e Infraestrutura</span>
          </h2>
          ...
          <div className="max-w-2xl xl:max-w-3xl fade-in-up stagger-4">
            <p className="text-base sm:text-lg md:text-xl text-slate leading-relaxed mb-8 sm:mb-12">
              ...
              <span className="text-green font-medium">Desenvolvimento fullstack</span>, 
              Infraestrutura multicloud e automações. Atualmente focado em criar 
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 fade-in-up stagger-5">
            <Button 
              ...
              className="btn-animated glow bg-transparent border-2 border-green text-green hover:bg-green hover:text-dark-navy font-mono text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto transition-all duration-200 group"
